...
@app.get("/")
def bienvenida():
    print("Bienvenido a la práctica de Rest")
    respuesta = {"mensaje" : "Bienvenido a la práctica de Rest",
...
def guardar_calificacion_por_id_alumno(id:int, foto:esquemas.FotoBase, sesion:Session=Depends(generador_sesion)):
    return repo.guardar_foto_por_id_alumno(sesion, id, foto)
